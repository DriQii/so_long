...
/*   Updated: 2023/12/21 20:41:00 by evella           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
{
	mlx_put_image_to_window(win->mlx, win->mlx_win, win->bg.img, win->ennemies.x, win->ennemies.y);
	mlx_put_image_to_window(win->mlx, win->mlx_win, win->ennemies.dead.img, win->ennemies.x, win->ennemies.y);
	mlx_do_sync(win->mlx);
	usleep(200000);
	mlx_put_image_to_window(win->mlx, win->mlx_win, win->bg.img, win->ennemies.x, win->ennemies.y);
	mlx_put_image_to_window(win->mlx, win->mlx_win, win->ennemies.dead2.img,  win->ennemies.x, win->ennemies.y);
	mlx_do_sync(win->mlx);
	usleep(100000);
	mlx_put_image_to_window(win->mlx, win->mlx_win, win->bg.img,  win->ennemies.x, win->ennemies.y);
	mlx_put_image_to_window(win->mlx, win->mlx_win, win->ennemies.dead3.img,  win->ennemies.x, win->ennemies.y);
	mlx_do_sync(win->mlx);
	usleep(300000);
	mlx_put_image_to_window(win->mlx, win->mlx_win, win->bg.img,  win->ennemies.x, win->ennemies.y);
}
