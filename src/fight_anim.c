...
/*   Updated: 2023/12/15 15:29:34 by evella           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
static void	ft_fightanim(t_win *win, t_anim anim)
{
	...
	mlx_put_image_to_window(win->mlx, win->mlx_win, anim.fight.img, win->player.x, win->player.y);
	mlx_do_sync(win->mlx);
	usleep(25000);
	mlx_put_image_to_window(win->mlx, win->mlx_win, win->bg.img, win->player.x, win->player.y);
	mlx_put_image_to_window(win->mlx, win->mlx_win, anim.fight2.img, win->player.x, win->player.y);
	mlx_do_sync(win->mlx);
	usleep(50000);
	mlx_put_image_to_window(win->mlx, win->mlx_win, win->bg.img, win->player.x, win->player.y);
	mlx_put_image_to_window(win->mlx, win->mlx_win, anim.fight3.img, win->player.x, win->player.y);
	mlx_do_sync(win->mlx);
	usleep(35000);
	mlx_put_image_to_window(win->mlx, win->mlx_win, win->bg.img, win->player.x, win->player.y);
	mlx_put_image_to_window(win->mlx, win->mlx_win, anim.fight.img, win->player.x, win->player.y);
